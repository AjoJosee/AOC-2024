...
# O(n)
#part 2 was ver vague so taking that christmas tree is symmetric about y axis but that didnt worked so not used
#this was not working for me coz considering density doesnt seem to work
smallest_answer = 99999999999999999999999999999999999999999999999999999999999999999999999
found_at_second = 0
for second in range(WIDE * TALL): # pattern will repeat every WIDE * TALL times
    ...
    for i in range(len(robots)):
        ...
        # for matplotlib visualisation so no impact
